...
TEST_CASE("Executable pattern test", "[kmpExecutablePatternPartTest]") {
    static const unsigned char pattern1[] = {
        0x48, 0x8B, 0x0D, 0x11, 0x11, 0x11, 0x11,
        0x48, 0x85, 0xC9, 0x75, 0x11,
        0x33, 0xC0, 0xC3, 0xE9, 0x11, 0x11, 0x11, 0x11,
        0x48, 0x89, 0x5C, 0x24, 0x10
    };

    std::ifstream binnaryFile{"files/unpacked_helldivers2.exe", std::ios::binary | std::ios::ate};
    REQUIRE(binnaryFile.is_open());
    size_t binnaryFileSize = binnaryFile.tellg();
    binnaryFile.seekg(0, std::ios::beg);
    ...
    algorithms::KmpSearcher<unsigned char> searcher {pattern1, utils::ArraySize(pattern1), 0x11};
